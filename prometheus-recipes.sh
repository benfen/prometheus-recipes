...
{
	local first_option all_short_options='agknh'
	first_option="${1:0:1}"
...
print_help()
{
	...
	printf 'Usage: %s [--(no-)delete] [-a|--(no-)deploy-alertmanager] [-g|--(no-)deploy-grafana] [-k|--(no-)deploy-kube-state-metrics] [-n|--(no-)deploy-node-exporter] [-h|--help] [<namespaces>]\n' "$0"
